...
class MediaCharacterPagingSource(
...
): PagingSource<Int, MediaCharacterEntry>() {
    override fun getRefreshKey(state: PagingState<Int, MediaCharacterEntry>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MediaCharacterEntry> {
