...
class MediaRecommendationDetailPagingSource(
    private val repository: NetworkRepository,
    private val id: String,
    private val type: String
): PagingSource<Int, MediaDetailRecommendation>() {
    override fun getRefreshKey(state: PagingState<Int, MediaDetailRecommendation>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MediaDetailRecommendation> {
        val page = params.key ?: 1
        return repository.getAnimeDetailRecommendations(
            id = id,
            type = type,
            page = page,
