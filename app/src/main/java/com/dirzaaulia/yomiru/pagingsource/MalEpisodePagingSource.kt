...
class MalEpisodePagingSource(
    private val repository: NetworkRepository,
    private val id: String,
) : PagingSource<Int, MalEpisode>() {
    override fun getRefreshKey(state: PagingState<Int, MalEpisode>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MalEpisode> {
